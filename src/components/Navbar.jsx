...
export default function Navbar() {
  ...
  const NavLink = ({ id, label, onClick }) => {
    ...
    return (
      <a
        ...
        onClick={onClick}
        className={[
          "relative px-2 py-1 transition hover:text-indigo-600",
  ...
  return (
    ...
    >
      <nav className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
      ...
      {open && (
        <>
          ...
          <div
            ...
            aria-modal="true"
          >
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-4 flex flex-col gap-3">
              {LINKS.map((l) => (
                <a
                  key={l.id}
                  href={`#${l.id}`}
